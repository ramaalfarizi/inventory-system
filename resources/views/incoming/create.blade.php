...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Create Incoming Item') }}</div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="entry_date" class="form-control" id="entry_date" placeholder="">
                                </div>
                            </div>
                            <div class="col">
                                <div class="mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="sender_phone" class="form-control" id="sender_phone" placeholder="">
                                </div>
                            </div>
                        </div>
                        <div class="row">
